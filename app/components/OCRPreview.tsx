...
export default function OCRPreview({ markdown, imageUrl, isLoading = false, error = null }: OCRPreviewProps) {
  ...
  useEffect(() => {
    ...
    html = html.replace(/(<li class="mb-1">.*?<\/li>(?:<br \/>)*)+/g, (match) => {
            ...
            {error ? (
              ...
              <div className="flex items-center justify-center h-full">
                <div className="text-center">
                  ...
                  <div className="text-gray-500 text-sm mt-1">画像を解析しています</div>
                </div>
              </div>
            ) : renderedHtml ? (
              ...
              <div className="flex items-center justify-center h-full">
                <div className="text-center">
                  ...
                  <div className="text-gray-500 font-medium">OCR結果がここに表示されます</div>
                  <div className="text-gray-400 text-sm mt-1">画像を撮影してOCR処理を開始してください</div>
                </div>
              </div>
            )}
          </div>
