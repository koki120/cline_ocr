...
export default function ProtectedEditor() {
  ...
  const [selectedResult, setSelectedResult] = useState<OCRResult | null>(ocrResults[0] || null);
      ...
      <main className="container mx-auto p-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white border rounded p-4 md:col-span-2">
            ...
            {selectedResult ? (
              ...
              <div className="text-center py-8">
                <p className="text-gray-500">OCR結果を選択して編集を開始してください</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="mt-8 bg-green-50 rounded-lg p-6">
          ...
          <ul className="list-disc list-inside space-y-2 text-green-700">
            ...
            <li>セッションは7日間有効です</li>
            <li>セキュリティのため、使用後はログアウトすることをお勧めします</li>
          </ul>
        </div>
      </main>
    </div>
